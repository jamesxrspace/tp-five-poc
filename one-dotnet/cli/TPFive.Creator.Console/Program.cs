...
builder
    ...
    .ConfigureServices((context, collection) =>
    {
        ...
        collection.AddHostedService<TPFive.Creator.Console.Application>();
        collection.AddScoped<TPFive.Creator.Console.IUploadService, TPFive.Creator.Console.UploadService>();
    });
