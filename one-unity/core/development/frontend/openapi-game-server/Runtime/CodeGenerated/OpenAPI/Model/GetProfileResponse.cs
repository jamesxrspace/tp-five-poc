...
namespace TPFive.OpenApi.GameServer.Model
{
    ...
    /// 
    /// </summary>
    public class GetProfileResponse : BaseResponse, IEquatable<GetProfileResponse>
    {
        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((GetProfileResponse)obj);
        }

        /// <summary>
        /// Returns true if GetProfileResponse instances are equal.
        /// </summary>
        /// <param name="other">Instance of GetProfileResponse to be compared.</param>
        /// <returns>Boolean.</returns>
