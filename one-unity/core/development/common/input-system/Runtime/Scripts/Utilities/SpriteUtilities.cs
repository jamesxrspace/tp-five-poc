...
namespace TPFive.Extended.InputSystem.Utilities
{
    /// <summary>
    /// Clone from <see cref="Unity.InputSystem.Utilities.SpriteUtilities"/>
    /// Doesn't overwrite any code, just some code needs this so cloned here.
    /// </summary>
