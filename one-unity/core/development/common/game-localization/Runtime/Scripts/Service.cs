...
namespace TPFive.Game.Localization
{
    ...
    [ServiceProvidedBy(typeof(TPFive.Game.Localization.IServiceProvider))]
    [RegisterToContainer]
        ...
        IService
    {
            ...
            ILoggerFactory loggerFactory)
        {
            ...
            // NullServiceProvider = new NullServiceProvider();
        }
        ...
        public void ChangeLanguage(string language)
        {
            ...
            serviceProvider.ChangeLanguage(language);
        }
        ...
        public string GetTerm(string termId)
        {
            ...
            return serviceProvider.GetTerm(termId);
        }
    }
}
