...
namespace UnityEditor.AddressableAssets.Build.DataBuilders
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "BuildScriptPacked.asset", menuName = "Addressables/Content Builders/BuildScriptPackedMode_ImplicitShaderReference")]
    public class BuildScriptPackedMode_ImplicitShaderReference : BuildScriptBase
    {
        /// <inheritdoc />
