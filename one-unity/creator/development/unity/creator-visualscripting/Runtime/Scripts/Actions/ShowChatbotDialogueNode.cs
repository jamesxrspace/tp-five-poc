...
namespace TPFive.Creator.VisualScripting
{
    ...
    //
    [UnitTitle("XrSpace: Show Chatbot Dialogue")]
    [UnitSurtitle("XrSpace")]
    [UnitShortTitle("Show Chatbot Dialogue")]
    [UnitCategory("XrSpace\\Actions")]
    [TypeIcon(typeof(CreatorComponentBase))]
    public class ShowChatbotDialogueNode : UnitBase
    {
        [DoNotSerialize]
        [PortLabelHidden]
        ...
        {
            CrossBridge.Logging?.Invoke(typeof(ShowChatbotDialogueNode), 0, "Process");
            ...
            if (CrossBridge.ShowChatbotDialogue == null)
            {
                CrossBridge.Logging?.Invoke(typeof(ShowChatbotDialogueNode), 0, "Don't have ShowChatbotDialogue");
                return outputTrigger;
            }

            CrossBridge.ShowChatbotDialogue?.Invoke(
