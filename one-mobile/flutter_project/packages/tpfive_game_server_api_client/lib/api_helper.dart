...
String parameterToString(dynamic value) {
  ...
  if (value is AvatarModelType) {
    return AvatarModelTypeTypeTransformer().encode(value).toString();
  }
  if (value is CategoriesEnum) {
    return CategoriesEnumTypeTransformer().encode(value).toString();
  }
  if (value is JoinModeEnum) {
    return JoinModeEnumTypeTransformer().encode(value).toString();
  }
